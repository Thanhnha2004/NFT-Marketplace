...
//         vm.prank(USER2);
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__PriceMismatch.selector);
//         nftMarketplace.buy{value: 0.5 ether}(tokenId);

//         vm.prank(USER2);
//         nftMarketplace.buy{value: 1 ether}(tokenId);
//         vm.prank(USER3);
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__ItemAlreadySold.selector);
//         nftMarketplace.buy{value: 1 ether}(tokenId);
//     }
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__ListingDelayNotMet.selector);
//         nftMarketplace.buy{value: 1 ether}(tokenId);
...
//         nftMarketplace.buy{value: 1 ether}(tokenId);
//         NFTMarketplace.MarketItem memory item = nftMarketplace.getItemForTokenId(tokenId);

//         uint256 itemSold = nftMarketplace.getItemSold();
//         (address royaltyReceiver, uint256 royaltyAmount) = nftMarketplace.royaltyInfo(tokenId, price);
//         uint256 feeMarketAmount = (price * marketplaceFeeBP) / MARKETPLACE_FEE_DENOM;
//         uint256 receiverProceed = nftMarketplace.getProceedsForAddress(royaltyReceiver);
//         uint256 contractProceed = nftMarketplace.getProceedsForAddress(nftMarketplace.getOwner());
//         uint256 listerProceed = nftMarketplace.getProceedsForAddress(item.lister);
...
//         assertEq(royaltyReceiver, USER1);
//         assertEq(feeMarketAmount, 0.03 ether);
//         assertEq(contractProceed, feeMarketAmount);
//         if(item.lister == royaltyReceiver){
//             assertEq(listerProceed, price - royaltyAmount - feeMarketAmount + royaltyAmount);
//             assertEq(receiverProceed, price - royaltyAmount - feeMarketAmount + royaltyAmount);
//         } else {
//             assertEq(listerProceed, price - royaltyAmount - feeMarketAmount);
//             assertEq(receiverProceed, royaltyAmount);
//         }
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__OnlyTokenOwnerCanResell.selector);
//         nftMarketplace.reSell{value: listingFee}(tokenId, price);

//         vm.stopPrank();

//         vm.startPrank(USER2);

//         vm.expectRevert(NFTMarketplace.NFTMarketplace__AmountMustBeAboveZero.selector);
//         nftMarketplace.reSell{value: listingFee}(tokenId, 0);

//         vm.expectRevert(NFTMarketplace.NFTMarketplace__ListingFeeMismatch.selector);
//         nftMarketplace.reSell{value: 0 ether}(tokenId, price);
...
//         vm.expectEmit();
//         emit ReSell(tokenId, USER2, price);
//         vm.prank(USER2);
//         nftMarketplace.reSell{value: listingFee}(tokenId, price);
//     }
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__AmountMustBeAboveZero.selector);
//         nftMarketplace.updateListingFee(0);

//         vm.expectRevert(NFTMarketplace.NFTMarketplace__AmountMustBeAboveZero.selector);
//         nftMarketplace.updateMintFee(0);
...
//         nftMarketplace.updateListingFee(0.02 ether);
...
//         nftMarketplace.updateMintFee(0.02 ether);
...
//         vm.expectEmit();
//         emit ListingFeeUpdated(0.02 ether);
//         nftMarketplace.updateListingFee(0.02 ether);
...
//         vm.expectEmit();
//         emit MintFeeUpdated(0.02 ether);
//         nftMarketplace.updateMintFee(0.02 ether);
...
//         uint256 currentProceed = nftMarketplace.getProceedsForAddress(USER1);
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__CallerNotOwner.selector);
//         nftMarketplace.cancelListing(tokenId);

//         vm.stopPrank();
//     }

//     function test_revertItemAlreadySold_cancelListing() public buy {
//         uint256 tokenId = 0;
//         vm.startPrank(USER1);
...
//         uint256 tokenId = 0;
//         nftMarketplace.cancelListing(tokenId);
//         NFTMarketplace.MarketItem memory marketItem = nftMarketplace.getItemForTokenId(tokenId);
...
//         vm.expectEmit();
//         emit CancelListing(tokenId, USER1);
//         vm.prank(USER1);
//         nftMarketplace.cancelListing(tokenId);
//     }
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__AmountMustBeAboveZero.selector);
//         nftMarketplace.placeOffer{value: 2 ether}(tokenId, 0);

//         vm.expectRevert(NFTMarketplace.NFTMarketplace__IncorrectPaymentAmount.selector);
//         nftMarketplace.placeOffer{value: 3 ether}(tokenId, price);
...
//         nftMarketplace.placeOffer{value: 2 ether}(tokenId, price);

//         NFTMarketplace.Offer memory item = nftMarketplace.getOfferForTokenId(tokenId, USER2);
//         uint256 refundProceed = nftMarketplace.getProceedsForAddress(USER2);

//         assertEq(USER2.balance, 7 ether);
//         assertEq(refundProceed, 1 ether);
...
//         vm.expectEmit();
//         emit PlaceOffer(tokenId, USER2, price);
//         nftMarketplace.placeOffer{value: 3 ether}(tokenId, price);
...
//         nftMarketplace.placeOffer{value: 2 ether}(tokenId, 2 ether);

//         vm.stopPrank();
//         _;
//     }

//     function test_revert_cancelOffer() public offer {
//         uint256 tokenId = 0;

//         vm.prank(USER1);
//         nftMarketplace.acceptOffer(tokenId, USER2);

//         vm.startPrank(USER2);

//         vm.expectRevert(NFTMarketplace.NFTMarketplace__OfferNotActive.selector);
//         nftMarketplace.cancelOffer(tokenId);
...
//         assertEq(refundProceed, 2 ether);
...
//         vm.expectEmit();
//         emit CancelOffer(tokenId, USER2, price);
//         nftMarketplace.cancelOffer(tokenId);
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__CallerNotTokenOwner.selector);
//         nftMarketplace.acceptOffer(tokenId, USER2);
...
//         assertEq(item.owner, USER2);
//         assertEq(nftMarketplace.ownerOf(tokenId), address(USER2));
//         assertEq(royaltyAmount, 0.2 ether);
//         assertEq(royaltyReceiver, USER1);
//         assertEq(feeMarketAmount, 0.06 ether);
//         assertEq(contractProceed, feeMarketAmount);
//         if(item.lister == royaltyReceiver){
//             assertEq(listerProceed, price - royaltyAmount - feeMarketAmount + royaltyAmount);
//             assertEq(receiverProceed, price - royaltyAmount - feeMarketAmount + royaltyAmount);
...
//         vm.expectEmit();
//         emit AcceptOffer(tokenId, USER1, USER2, price);
//         nftMarketplace.acceptOffer(tokenId, USER2);
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__InvalidAuctionDuration.selector);
...
//         nftMarketplace.createAuction{value: listingFee}(tokenId, startingPrice, duration);
//         NFTMarketplace.MarketItem memory marketItem = nftMarketplace.getItemForTokenId(tokenId);
//         NFTMarketplace.Auction memory auctionItem = nftMarketplace.getAuctionForTokenId(tokenId);
...
//         vm.expectEmit();
//         emit CreateAuction(tokenId, USER1, startingPrice, block.timestamp + duration);
//         nftMarketplace.createAuction{value: listingFee}(tokenId, startingPrice, duration);
...
//         nftMarketplace.createAuction(tokenId, startingPrice, duration);
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__BidBelowMinimum.selector);
//         nftMarketplace.placeBid{value: 1 ether}(tokenId);
...
//         vm.expectRevert(NFTMarketplace.NFTMarketplace__AuctionHasEnded.selector);
//         nftMarketplace.placeBid(tokenId);

//         vm.stopPrank();
//     }

//     function test_revertAuctionInactive_placeBid() public auction {
//         uint256 tokenId = 0;
//         uint256 price = 2 ether;

//         vm.prank(USER1);
//         nftMarketplace.cancelAuction(tokenId);
...
//         nftMarketplace.placeBid{value: firstPrice}(tokenId);

//         vm.stopPrank();

//         vm.startPrank(USER3);

//         nftMarketplace.placeBid{value: secondPrice}(tokenId);
...
//         vm.expectEmit();
//         emit PlaceBid(tokenId, USER2, price);
//         nftMarketplace.placeBid{value: price}(tokenId);
...
//         uint256 oldEndTime = nftMarketplace.getAuctionForTokenId(tokenId).endTime;
//         vm.warp(oldEndTime - 300);

//         nftMarketplace.placeBid{value: price}(tokenId);

//         uint256 newEndTime = nftMarketplace.getAuctionForTokenId(tokenId).endTime;

//         assertEq(oldEndTime + AUCTION_EXTENSION, newEndTime);
...
//     /////////////////      EndAuction Tests      /////////////
//     //////////////////////////////////////////////////////////
//     function test_revertAuctionInactive_endAuction() public auction {
//         uint256 tokenId = 0;
...
//         vm.prank(USER2);
//         nftMarketplace.placeBid{value: priceBid}(tokenId);
...
//         uint256 feeMarketAmount = (priceBid * marketplaceFeeBP) / MARKETPLACE_FEE_DENOM;
//         uint256 receiverProceed = nftMarketplace.getProceedsForAddress(royaltyReceiver);
//         uint256 contractProceed = nftMarketplace.getProceedsForAddress(nftMarketplace.getOwner());
//         uint256 listerProceed = nftMarketplace.getProceedsForAddress(item.lister);
...
//         assertEq(royaltyReceiver, USER1);
//         assertEq(feeMarketAmount, 0.09 ether);
//         assertEq(contractProceed, feeMarketAmount);
//         if(item.lister == royaltyReceiver){
//             assertEq(listerProceed, priceBid - royaltyAmount - feeMarketAmount + royaltyAmount);
//             assertEq(receiverProceed, priceBid - royaltyAmount - feeMarketAmount + royaltyAmount);
//         } else {
//             assertEq(listerProceed, priceBid - royaltyAmount - feeMarketAmount);
//             assertEq(receiverProceed, royaltyAmount);
//         }
...
//         vm.expectEmit();
//         emit EndAuction(tokenId, nftMarketplace.getAuctionForTokenId(tokenId).highestBidder, nftMarketplace.getAuctionForTokenId(tokenId).highestBid);
//         nftMarketplace.endAuction(tokenId);
...
//         assertFalse(nftMarketplace.getAuctionForTokenId(tokenId).active);
//         assertEq(itemSold, 0);
//         assertEq(nftMarketplace.getItemForTokenId(tokenId).price, 0 ether);
...
//         NFTMarketplace.Auction memory auction = nftMarketplace.getAuctionForTokenId(tokenId);
...
//         vm.expectEmit();
//         emit CancelAuction(tokenId, nftMarketplace.getAuctionForTokenId(tokenId).lister);
//         nftMarketplace.cancelAuction(tokenId);
